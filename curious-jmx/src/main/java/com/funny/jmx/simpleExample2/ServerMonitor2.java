...
public class ServerMonitor2 implements DynamicMBean {

	private MBeanInfo mBeanInfo;
	private final ServerImpl target;

	public ServerMonitor2(ServerImpl target) {
		this.target = target;
	}
	...
	public MBeanInfo getMBeanInfo() {
		if (mBeanInfo == null) {
			try {
				...
				mBeanInfo = new MBeanInfo(cls.getName(), "Monitor that controls the server", new MBeanAttributeInfo[] { upTimeMBeanAttributeInfo },
